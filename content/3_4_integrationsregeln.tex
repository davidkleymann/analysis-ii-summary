...
\begin{Satz}{Substitutionsregeln in $n$ Dimensionen}{}
    ...
    \[
        \int_\Omega f(x_1, \hdots, x_n)dx_1\hdots dx_1 = \int_{\widetilde{\Omega}} f(g_1(u), \hdots, g_n(u)) \cdot |\det J_\phi|\ du_1\hdots du_n
    \]
    wobei das Gebiet $\widetilde{\Omega} = \Phi^{-1}(\Omega)$ ist. $|\det J_\phi|$ ist die \textbf{Funktionaldeterminante} (Jakobi-Determinante).
\end{Satz}
